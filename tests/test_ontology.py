...
class TestCreateGODagNoObsolete(unittest.TestCase):
    ...
    def setUp(self):
        self.godag = GODag(os.path.join(os.path.dirname(os.path.abspath(__file__)), "data/go1.obo"))
    ...
    def test_GO0000006_entry(self):
        ...
        self.assertEqual(self.godag["GO:0000006"].description, '"child of second level 1" [TC:2.A.5.1.1]')
        self.assertEqual(self.godag["GO:0000006"]._parents, {"GO:0000002"})
        self.assertEqual(self.godag["GO:0000006"].parents, {self.godag["GO:0000002"]}) #direct parents
        self.assertEqual(self.godag["GO:0000006"].children, {self.godag["GO:0000015"]}) #direct children
    ...
    def test_GO0000015_partof(self):
        ...
        self.assertEqual(self.godag["GO:0000015"].parents, {self.godag["GO:0000006"], self.godag["GO:0005829"]})
    ...
    def test_get_all_parents(self):
        ...
        self.assertEqual(self.godag["GO:0000006"].get_all_parents(), {"GO:0000002", "GO:0000001"})

    def test_get_all_children(self):
        """Check get_all_children function of class GOTerm"""
        self.assertEqual(self.godag["GO:0000002"].get_all_children(), {"GO:0000006", "GO:0000015"})
